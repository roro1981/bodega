...
$("#btnAgregarArt").unbind('click').bind('click', function () {
  $.ajax({
    type : 'POST',
...
$("#term_pedido").unbind('click').bind('click', function () {
	...
	$.ajax({
      ...
      <div class='row form-group' >
    	<div class="col-sm-4">
			<button id="btnAgregarArt" type="button" data-toggle="modal" data-target="#modalProd" class="btn btn-primary" title="Agregar productos"> Agregar productos <span class="fa fa-plus"></span></button>
    	</div>
	...
	<div class='row'>	
		<div class='col-md-12'>
          ...
          <table id="tab_pedidos" class="table table-bordered">
			<thead>
				<tr>
		...
		<button id="term_pedido" class="btn btn-success">Terminar pedido</button>
          </div>
          </div>
        </div>
        <!--modal productos-->
