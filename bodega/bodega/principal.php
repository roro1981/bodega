            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <small style="margin-right:5px" class="bg-green usuario_activo">Usuario activo: <?php echo $_SESSION['nombre']; ?></small>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            $usua=$_SESSION['id_user'];
            $valida = $usuario->verifica_acceso_modulo($usua,5); 
            if($valida==1){
            ?>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
               <?php 
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,17); 
                if($valida==1){
                ?>  
                <li id="ped_faenas"><a href="#"><i class="fa fa-circle-o"></i> Pedidos desde faenas</a></li>
                <?php }
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,18); 
                if($valida==1){
                ?>  
                <li id="dev_faenas"><a href="#"><i class="fa fa-circle-o"></i> Devoluciones desde faenas</a></li>
                <?php } ?>
           ...
           <!--inicio menu -->
            ...
            $usuario = new usersDao();
            $usua=$_SESSION['id_user'];
            $valida = $usuario->verifica_acceso_modulo($usua,4); 
            if($valida==1){
            ?>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
               <?php 
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,12); 
                if($valida==1){
                ?>  
                <li id="ent_sal"><a href="#"><i class="fa fa-circle-o"></i> Entradas-salidas</a></li>
                <?php }
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,16); 
                if($valida==1){
                ?>  
                <li id="ent_masiva"><a href="#"><i class="fa fa-circle-o"></i> Entradas-masivas</a></li>
                <?php }
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,14); 
                if($valida==1){
                ?>  
                <li id="histo_mov"><a href="#"><i class="fa fa-circle-o"></i> Historial de movimientos</a></li>
                <?php } ?>
            ...
            $usuario = new usersDao();
            $usua=$_SESSION['id_user'];
            $valida = $usuario->verifica_acceso_modulo($usua,2); 
            if($valida==1){
            ?>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
               <?php 
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,5); 
                if($valida==1){
                ?>  
                <li id="gestion_productos"><a href="#"><i class="fa fa-circle-o"></i> Gestión de productos</a></li>
                <?php }
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,7); 
                if($valida==1){
                ?>  
                <li id="categorias"><a href="#"><i class="fa fa-circle-o"></i> Categorías</a></li>
                <?php } 
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,8); 
                if($valida==1){
                ?>  
                <li id="subcategorias"><a href="#"><i class="fa fa-circle-o"></i> Subcategorías</a></li>
                <?php } ?>
              </ul>
            </li>
            <?php } ?>
            ...
            $usuario = new usersDao();
            $usua=$_SESSION['id_user'];
            $valida = $usuario->verifica_acceso_modulo($usua,3); 
            if($valida==1){
            ?>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
               <?php 
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,9); 
                if($valida==1){
                ?>  
                <li id="faenas"><a href="#"><i class="fa fa-circle-o"></i> Gestión de faenas</a></li>
                <?php }
                $usuario = new usersDao();
                $usua=$_SESSION['id_user'];
                $valida = $usuario->verifica_acceso_submodulo($usua,10); 
                if($valida==1){
                ?>  
                <li id="faenas_bod"><a href="#"><i class="fa fa-circle-o"></i> Bodegas faenas</a></li>
                <?php } ?>
              </ul>
            </li>
            <?php } ?>
            ...
            $usuario = new usersDao();
            $usua=$_SESSION['id_user'];
            $valida = $usuario->verifica_acceso_modulo($usua,1); 
            if($valida==1){
            ?>
                <li class="treeview">
                  <a href="#">
                  ...
                  <ul class="treeview-menu">
                    ...
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,1); 
                    if($valida==1){
                    ?>  
                    <li id="new_usuario"><a href="#"><i class="fa fa-circle-o"></i>Crear usuario</a></li>
                    <?php } ?>
                    <?php 
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,2); 
                    if($valida==1){
                    ?>  
                    <li id="mod_usuario"><a href="#"><i class="fa fa-circle-o"></i>Editar usuario</a></li>
                    <?php } ?>
                    <?php 
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,3); 
                    if($valida==1){
                    ?>  
                    <li id="elim_usuario"><a href="#"><i class="fa fa-circle-o"></i>Eliminar usuario</a></li>
                    <?php } ?>
                    <?php 
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,4); 
                    if($valida==1){
                    ?>  
                    <li id="permisos"><a href="#"><i class="fa fa-circle-o"></i>Permisos</a></li>
                    <?php } ?>
                  </ul>
                </li>
            <?php } ?>
            ...
            $usuario = new usersDao();
            $usua=$_SESSION['id_user'];
            $valida = $usuario->verifica_acceso_modulo($usua,6); 
            if($valida==1){
            ?>
                <li class="treeview">
                  <a href="#">
                    <i class="fa fa-user"></i>
                    <span>USUARIOS FAENAS</span>
                    <i class="fa fa-angle-left pull-right"></i>
                  </a>
                  <ul class="treeview-menu">
                    <?php 
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,19); 
                    if($valida==1){
                    ?>  
                    <li id="new_usuario_faena"><a href="#"><i class="fa fa-circle-o"></i>Crear usuario faena</a></li>
                    <?php } ?>
                    <?php 
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,20); 
                    if($valida==1){
                    ?>  
                    <li id="mod_usuario_faena"><a href="#"><i class="fa fa-circle-o"></i>Editar usuario faena</a></li>
                    <?php } ?>
                    <?php 
                    $usuario = new usersDao();
                    $usua=$_SESSION['id_user'];
                    $valida = $usuario->verifica_acceso_submodulo($usua,21); 
                    if($valida==1){
                    ?>  
                    <li id="elim_usuario_faena"><a href="#"><i class="fa fa-circle-o"></i>Eliminar usuario faena</a></li>
                    <?php } ?>
                  </ul>
                </li>
            <?php } ?>
